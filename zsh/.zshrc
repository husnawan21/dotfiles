...
# pnpm
export PNPM_HOME="/Users/husnawan/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
_fzf_compgen_dir() {
  fd --type d --hidden --follow --exclude ".git" . "$1" . "node_modules"
}

# export FZF_DEFAULT_OPTS="--extended --ansi --color=bg+:#1a1b26,fg+:#73DE72,pointer:#17D262,hl:#D21771,hl+:#D21771,info:#3d4651 --pointer '👉' --preview-window 'down,right:60%' --layout reverse --margin=2% --no-info"alias lg='lazygit'
# export FZF_DEFAULT_OPTS="--extended"
alias lg='lazygit'

# bun completions
[ -s "/Users/husnawan/.bun/_bun" ] && source "/Users/husnawan/.bun/_bun"
